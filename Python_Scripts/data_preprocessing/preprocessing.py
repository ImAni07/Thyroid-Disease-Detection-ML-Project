...
class Preprocessor:
    ...
    def is_null_present(self,data):
        ...
        try:
            ...
            if(self.null_present):
                ...
                dataframe_with_null.to_csv(r'path\to\null_values.csv') 
    ...
    def encodeCategoricalValues(self,data):
        ...
        # Except for 'Sex' Column all the Other Columns with 2 Categorical data have same value 'f' and 't'.
        # So, Instead of Mapping Indvidually
        # Let's do a Smart Work
        ...
        for column in data.columns:
            ...
            # Now there are handful of column left with more than 2 categories.
            ...
            # We will save the encoder as pickle to use when we do the prediction.
            # We will need to decode the predcited values back to original
    ...
    def encodeCategoricalValuesPrediction(self,data):
        ...
        # so instead of mapping indvidually, let's do a Smart Work
    ...
    def handleImbalanceDataset(self,X,Y):
        ...
        x_sampled, y_sampled = rdsmple.refit_sample(X, Y)
